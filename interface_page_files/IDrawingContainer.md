...
<div class="interface" style="margin: 5px 20%;">IDrawingContainer</div>
</div>
...
1. **Из вида документа:**
   - [`IViews::GetActiveView()`](docs/Приложение KompasAPI/Документы/Документ 2D/Вид/IView.md) - получение активного вида
   - [`IViews::GetViewByNumber()`](docs/Приложение KompasAPI/Документы/Документ 2D/Вид/IView.md) - получение вида по номеру
...
**Полное описание:** Метод предоставляет доступ к коллекции полных окружностей. Окружности используются для создания круглых отверстий, обозначений и других элементов с радиальной симметрией. В отличие от дуг, окружности всегда представляют полный круг. Коллекция [`ICircles`](docs/Приложение KompasAPI/Документы/Документ 2D/Вид/Коллекции объектов/Графические объекты/ICircles.md) позволяет добавлять новые окружности и управлять их параметрами.
...
[Группа методов](#группа-5-утилитарные-методы) | [К оглавлению](#методы-интерфейса)
