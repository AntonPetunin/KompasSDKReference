...
/// Типы 3D объектов.
enum ksObj3dTypeEnum ENUM_SIZE
{
  ...
  o3d_MultiSpline                  = 645,  ///< Ассоциативный сплайн по объектам.
  o3d_BodySurfaceRemover           = 646,  ///< Операция удаления  тел и поверхностей.
  o3d_UserComponentOperation       = 647,  ///< Пользовательская операция над вставками.
  o3d_FilletChanger                = 648,  ///< Изменить размер скругления.
  o3d_CurvatureGraphs              = 649,  ///< Папка Графиков кривизны.
  o3d_Diagnostic                   = 650,  ///< Диагностика.
  o3d_CurvatureCheckObjects        = 651,  ///< Папка Проверки кривизны.
  o3d_ContinuityCheckGroup         = 655,  ///< Папка Проверки непрерывности.
  o3d_CollisionCheck               = 656,  ///< Папка Проверки коллизий.
  o3d_MutualDeviationFolder        = 657,  ///< Папка взаимного отклонения.
  o3d_MutualDeviation              = 658,  ///< Взаимное отклонение.
  o3d_FaceReplacer                 = 659,  ///< Заменить грани.
  o3d_FaceResizer                  = 660,  ///< Изменить размер грани.
  o3d_Deviation                    = 661,  ///< Отклонение.
  o3d_Sphere                       = 662,  ///< Сфера.
  o3d_Cylinder                     = 663,  ///< Цилиндр.
  o3d_BlockByPoints                = 664,  ///< Параллелепипед по двум точкам и высоте.
  o3d_FilletSurface                = 665,  ///< Поверхность скругления.
  o3d_ExternalReference            = 667,  ///< Внешняя ссылка.
  o3d_BlockBySizes                 = 668,  ///< Параллелепипед по точке и трём размерам.
  o3d_ConeByAngle                  = 669,  ///< Конус по центру основания, диаметрам и углу.
  o3d_ConeByHeight                 = 670,  ///< Конус по центру основания, диаметрам и высоте.
  o3d_ConeByArcs                   = 671,  ///< Конус по двум дугам.
  o3d_MiddleSurface                = 672,  ///< Средняя поверхность.
  o3d_PipeElement                  = 673,  ///< Трубчатый элемент.
  o3d_MeshPatternFacesCopy         = 674,  ///< Массив граней по сетке.
  o3d_CircularPatternFacesCopy     = 675,  ///< Массив граней по концентрической сетке.
  o3d_CurvePatternFacesCopy        = 676,  ///< Массив граней вдоль кривой.
  o3d_MirrorPatternFacesCopy       = 677,  ///< Зеркальный массив граней.
  o3d_SketchPatternFacesCopy       = 678,  ///< Массив граней по точкам.
  o3d_TablePatternFacesCopy        = 679,  ///< Массив граней по таблице.
...
/// Типы направлений.
enum ksDirectionTypeEnum ENUM_SIZE
{
...
/// Тип компонента.
enum Part_Type ENUM_SIZE
{
  pMainTop_Part  = -5,  ///< Верхний компонент (независимо от наличия редактирования на месте).
...
/// Типы сопряжений.
enum MateConstraintType ENUM_SIZE
{
...
enum D3FormatConvType ENUM_SIZE
{
...
/// Тип перемещения.
enum Positioner_Type ENUM_SIZE
{
  pnMove     = 0,  ///< Сдвиг.
  pnRotate   = 1   ///< Вращение.
};
...
/// Типы пересечений.
enum Intersection_Type ENUM_SIZE
{
...
enum ksLineBuildingType ENUM_SIZE
{
...
/// Тип коллекции компонентов.
enum ksPart7CollectionTypeEnum ENUM_SIZE
{
  ksAllParts = 0,  ///< Все включенные в расчет загруженные компоненты (включая копии из операций копирования).
  ksUniqueParts  = 1,  ///< Первые экземпляры вставок компонентов.
  ksExcludedAndUnloadParts = 2   ///< Все исключенные из расчета и выгруженные компоненты.
};


/// Способ определения длины развертки
enum ksUnfoldTypeEnum ENUM_SIZE
{
...
enum ksBendDisposalEnum ENUM_SIZE
{
...
enum ksBendLengthTypeEnum ENUM_SIZE
{
...
/// Тип смещения.
enum ksBendOffsetTypeEnum ENUM_SIZE
{
...
enum ksBendSideTypeEnum ENUM_SIZE
{
...
enum ksBendReleaseTypeEnum ENUM_SIZE
{
...
enum ksBendAngleReleaseTypeEnum ENUM_SIZE
{
...
enum ksHoleCutTypeEnum ENUM_SIZE
{
...
enum ksChooseBodiesType ENUM_SIZE
{
...
enum ksChoosePartsType ENUM_SIZE
{
...
enum ksPoint3DTypeEnum ENUM_SIZE
{
...
enum ksPoint3DCurveParamTypeEnum ENUM_SIZE
{
  ksOffsetByU      = 1,  ///< В % от длины кривой.
  ksOffsetByLen    = 2,  ///< По длине сегмента.
  ksOffsetByAngle  = 3   ///< По центральному углу дуги.
};


/// Типы смещений при способе построения точки на поверхности.
enum ksPoint3DSurfaceParamTypeEnum ENUM_SIZE
{
...
/// Типы смещений при способе построения точки на поверхности.
enum ksMeasureResultEnum ENUM_SIZE
{
  ksMResCalculate         = -1,  ///< Расчет выполнен.
  ...
  ksMResCenterCenterDistant = 12,  ///< Расстояние между центрами дуг.
  ksMResFromCenterDistant = 13   ///< Расстояние от центра дуги до ... .
};


/// Тип ориентирования ЛСК.
enum ksOrientationTypeEnum ENUM_SIZE
{
...
enum ksModelObjectParamTypeEnum ENUM_SIZE
{
...
enum ksFacetCullingMode ENUM_SIZE
{
...
enum ksEquidistant3DCutModeEnum ENUM_SIZE
{
...
enum ksPatternBasePointTypeEnum ENUM_SIZE
{
...
enum ksExtensionSurfaceTypeEnum ENUM_SIZE
{
...
/// Способ ограничения
enum ksExtensionLimitTypeEnum ENUM_SIZE
{
...
enum ksVector3DParametersTypeEnum ENUM_SIZE
{
...
enum ksBasisVectorTypeEnum ENUM_SIZE
{
...
enum ksConnectTypeEnum ENUM_SIZE
{
...
enum ksArc3DBuildingTypeEnum ENUM_SIZE
{
...
enum ksArc3DParameterEnum ENUM_SIZE
{
...
enum ksRotatedTypeEnum ENUM_SIZE
{
  ksRTAngle    =  0,  ///< Угол.
...
enum ksLinearPatternBuildingTypeEnum ENUM_SIZE
{
...
/// Тип доступа
enum ksPartAccessTypeEnum ENUM_SIZE
{
...
/// Способ построения массива по сетке.
enum ksMeshPointsSurfaceBuildingTypeEnum ENUM_SIZE
{
...
/// Способ построения массива по сетке.
enum ksCloudPointsSurfaceBuildingTypeEnum ENUM_SIZE
{
...
enum ksCloudTypeEnum ENUM_SIZE
{
...
enum ksObjectsFilter3DEnum ENUM_SIZE
{
  ...
  ksFilterMeshes       = 16,  ///< Фильтровать полигональные объекты.
  ksFilterTexts        = 17,  ///< Фильтровать надписи.
  ksFilterTables       = 18   ///< Фильтровать таблицы.
};


/// Порядок законов
enum ksCoordLawEnum ENUM_SIZE
{
  ksCLawX  = 0,  ///< Закон X.
  ksCLawY  = 1,  ///< Закон Y.
  ksCLawZ  = 2   ///< Закон Z.
...
enum ksCircularPatternBuildingTypeEnum ENUM_SIZE
{
...
enum ksSplineTangentEnum ENUM_SIZE
{
...
/// Тип проекции кривой.
enum ksCurveProjectionTypeEnum ENUM_SIZE
{
...
/// Тип контура.
enum ksContour3DTypeEnum ENUM_SIZE
{
...
enum ksLineSegment3DTypeEnum ENUM_SIZE
{
...
enum ksConjunctivePointTypeEnum ENUM_SIZE
{
...
enum ksContour3DBuildingTypeTypeEnum ENUM_SIZE
{
...
enum ksRelationTypeEnum ENUM_SIZE
{
...
enum ksSpiral3DHeightTypeEnum ENUM_SIZE
{
...
enum ksSpline3DBuildingTypeEnum ENUM_SIZE
{
...
enum ksSpline3DDiameterTypeEnum ENUM_SIZE
{
...
enum ksPointsArrOnCurveTypeEnum ENUM_SIZE
{
...
/// Способ построения точек группы.
enum ksPointsArrOnSurfaceTypeEnum ENUM_SIZE
{
...
enum ksMeshAroundPointTypeEnum ENUM_SIZE
{
...
enum ksEditColorTypeEnum ENUM_SIZE
{
...
/// Опции проецирования.
enum ksProjectionOptionEnum ENUM_SIZE
{
...
enum ksVisibleStateEnum ENUM_SIZE
{
...
enum ksEditableStateEnum ENUM_SIZE
{
...
enum ksToleranceRecalcsEnum ENUM_SIZE
{
...
enum ksSpecRoughPlacementEnum ENUM_SIZE
{
...
enum ksMathCurve3DTypeEnum ENUM_SIZE
{
  ks3DCurve                  = 0,  ///< Кривая.
  ksLine3D                   = 1,  ///< Прямая.
...
enum ksMathSurface3DTypeEnum ENUM_SIZE
{
...
enum ksLengthBuildingTypeEnum ENUM_SIZE
{
...
enum ksPatternExemplarsOrientationTypeEnum ENUM_SIZE
{
...
enum ksModelDrawingElementsEnum ENUM_SIZE
{
...
enum ksMateConstraintAlignmentEnum ENUM_SIZE
{
...
enum ksMateFixedTypeEnum ENUM_SIZE
{
...
/// Фиксация компонентов при создании сопряжения.
enum ksMateTangentTypeEnum ENUM_SIZE
{
  ksMTangentUnknown          = 0x0,  ///< Неопределено.
  ksMTangentByPoint          = 0x1,  ///< Касание в общем случае (контакт точкой).
  ksMTangentByGeneratrixLine = 0x2,  ///< Касание по образующей прямой (например два цилиндра с параллельными осями).
  ksMTangentByCircle         = 0x4   ///< Касание по окружности (например сфера в конусе).
};


/// Тип проекции.
enum ksViewProjectionType ENUM_SIZE
{
...
enum ksDepthTypeEnum ENUM_SIZE
{
...
enum ksEndFaceTypeEnum ENUM_SIZE
{
  ksEFFlat   = 0,  ///< Плоский.
...
enum ksCountersinkTypeEnum ENUM_SIZE
{
...
enum ksConicTypeEnum ENUM_SIZE
{
...
enum ksViewProjectionScheme ENUM_SIZE
{
...
enum ksMateMotionTypeEnum ENUM_SIZE
{
...
enum ksD3ConverterOptionsEnum ENUM_SIZE
{
...
enum ksTextExportFormEnum ENUM_SIZE
{
...
/// Состояние объекта.
enum ksFeatureStateEnum ENUM_SIZE
{
...
enum ksChamferBuildingTypeEnum ENUM_SIZE
{
...
enum ksFilletBuildingTypeEnum ENUM_SIZE
{
...
enum ksFilletOffsetModeEnum ENUM_SIZE
{
...
/// Результат операции.
enum ksOperationResultEnum ENUM_SIZE
{
...
enum ksLoftBuildingType ENUM_SIZE
{
...
enum ksEvolutionShiftSketchTypeEnum ENUM_SIZE
{
...
enum ksSketchBendBuildingTypeEnum ENUM_SIZE
{
...
enum ksClosingTypeEnum ENUM_SIZE
{
...
enum ksClosingCorneringEnum ENUM_SIZE
{
...
enum ksClosingHolePlacementEnum ENUM_SIZE
{
...
enum ksClosingClosedTypeEnum ENUM_SIZE
{
...
enum ksUndercutDistanceTypeEnum ENUM_SIZE
{
...
enum ksCutBuildingTypeEnum ENUM_SIZE
{
...
enum ksShoulderTypeEnum ENUM_SIZE
{
...
enum ksShoulderCutingTypeEnum ENUM_SIZE
{
...
enum ksShoulderBuildingTypeEnum ENUM_SIZE
{
...
enum ksJalousieBuildingTypeEnum ENUM_SIZE
{
...
/// Форма торца жалюзей.
enum ksJalousieFormEndEnum ENUM_SIZE
{
...
enum ksJalousieHeightTypeEnum ENUM_SIZE
{
...
enum ksPressFormingHeightTypeEnum ENUM_SIZE
{
...
enum ksSplineTransitionTypeEnum ENUM_SIZE
{
...
enum ksTransitionVectorIndexEnum ENUM_SIZE
{
...
enum ksSHRibBuildingTypeEnum ENUM_SIZE
{
...
enum ksSHRibCutingTypeEnum ENUM_SIZE
{
...
enum ksOffsetGapType ENUM_SIZE
{
...
enum ksRuledBorderEnum ENUM_SIZE
{
...
/// Типы кромки стыка.
enum ksRuledJointEnum ENUM_SIZE
{
...
enum ksSegmentationMethodEnum ENUM_SIZE
{
...
enum ksZoneDivisionTypeEnum ENUM_SIZE
{
...
enum ksGabaritBuildingTypeEnum ENUM_SIZE
{
...
enum ksDynamicCrossSectionStepBuildingTypeEnum ENUM_SIZE
{
...
enum ksCrossSectionPlaneBuildingTypeEnum ENUM_SIZE
{
...
enum ksArchMeasureEnum ENUM_SIZE
{
...
/// Способ разбиения зоны.
enum ksManipulatorTypeEnum ENUM_SIZE
{
...
enum ksManipulatorPrimitiveEnum ENUM_SIZE
{
...
enum ksManipulatorModeEnum ENUM_SIZE
{
...
enum ksSelectionBandMode ENUM_SIZE
{
...
enum ksProcessObjectsFilter3DEnum ENUM_SIZE
{
...
enum ksCopyGeometryBuildingTypeEnum ENUM_SIZE
{
...
enum ksMultiThicknessGroupTypeEnum ENUM_SIZE
{
...
/// Тип текстуры.
enum ksTextureTypeEnum ENUM_SIZE
{
...
enum ksSheetMetalPunchBuildingTypeEnum ENUM_SIZE
{
...
enum ksSheetMetalPunchThicknessTypeEnum ENUM_SIZE
{
...
enum ksScalingTypeEnum ENUM_SIZE
{
...
/// Версия оптимизации.
enum ksEvolutionVersionEnum ENUM_SIZE
{
...
enum ksTechnicalDemand3DPlacementEnum ENUM_SIZE
{
...
/// Тип ребер эскиза.
enum ksSketchEdgesTypeEnum ENUM_SIZE
{
...
enum ksConicCurve3DDBuildingTypeEnum ENUM_SIZE
{
...
enum ksConicCurve3DParameterEnum ENUM_SIZE
{
...
enum ksConicSurfaceBuildingTypeEnum ENUM_SIZE
{
...
enum ksConicSurfaceSideBuildingTypeEnum ENUM_SIZE
{
...
enum ksConicSurfaceSideAngleBuildingTypeEnum ENUM_SIZE
{
...
enum ksConicSurfaceSectionCurveFormEnum ENUM_SIZE
{
...
/// Движение сечения.
enum ksConicSurfaceMovementTypeEnum ENUM_SIZE
{
  ksConicSectionSelfParallel     = 0,  ///< Параллельно самому себе.
  ksConicSectionAllongAxis       = 1,  ///< По осевой линии.
  ksConicSectionByRadial         = 2   ///< Радиально, вокруг заданной оси.
};


/// Движение сечения.
enum ksConicSectionTrianglePointEnum ENUM_SIZE
{
...
/// Движение сечения.
enum ksSideAngleTypeEnum ENUM_SIZE
{
...
enum ksVariableRadiusBuildingTypeEnum ENUM_SIZE
{
...
enum ksCornerFormEnum ENUM_SIZE
{
...
/// Тип вырубки кромки.
enum ksSheetMetalPunchEdgeTypeEnum ENUM_SIZE
{
...
enum ksParametersTypeEnum ENUM_SIZE
{
...
enum ksExtensionCurveTypeEnum ENUM_SIZE
{
...
/// Способ построения линейчатой поверхности.
enum ksRuledSurfaceBuildingTypeEnum ENUM_SIZE
{
...
enum ksRuledSurfaceMovementTypeEnum ENUM_SIZE
{
  ksRuledSurfaceMovementByVector = 0,  ///< Параллельно самому себе. По направлению, заданному вектором.
  ksRuledSurfaceMovementByCurve  = 1,  ///< По осевой линии. Вдоль траектории, заданной кривой.
  ksRuledSurfaceMovementByRadial = 2   ///< Радиально, вокруг заданной оси.
};


/// Способ выравнивания сечения.
enum ksRuledSurfaceSectionAlignmentTypeEnum ENUM_SIZE
{
  ksRuledSurfaceSectionAlignmentByParam  = 0,  ///< По параметру направляющих.
  ksRuledSurfaceSectionAlignmentByLen    = 1,  ///< По длине направляющих.
  ksRuledSurfaceSectionAlignmentByVertex = 2,  ///< По вершинам.
  ksRuledSurfaceSectionAlignmentByPath   = 3   ///< По объекту.
};


/// Направление построения линейчатой поверхности.
enum ksRuledSurfaceDirectionTypeEnum ENUM_SIZE
{
...
/// Метод сглаживания.
enum ksSmoothingMethodEnum ENUM_SIZE
{
...
/// Способ построения.
enum ksSplineBuildingTypeEnum ENUM_SIZE
{
...
/// Принадлежность к семейству моделей.
enum ksModelsFamilyTypeEnum ENUM_SIZE
{
  ksModelsFamilyNone = 0,  ///< Документ не принадлежит семейству моделей.
  ksModelsFamilyCopy = 1,  ///< Экземпляр семейства моделей.
  ksModelsFamilyTemplate = 2   ///< Шаблон для генерации семейства моделей.
};


/// Ошибки данных семейства моделей.
enum ksModelsFamilyErrorEnum ENUM_SIZE
{
  ksModelsFamilyError             = -1,  ///< Параметры шаблона семейства моделей не заданы.
  ksModelsFamilyOk                = 0,  ///< Проверка прошла успешно.
  ksModelsFamilyEmptyFilename     = 1,  ///< Не задано имя файла для экземпляра семейства.
  ksModelsFamilyNotUniqueFilename = 2,  ///< Имя файла экземпляра семейства не уникально.
  ksModelsFamilyToLongFilename    = 3,  ///< Слишком длинное имя файла для экземпляра семейства.
  ksModelsFamilyBadFilename       = 4,  ///< Имя файла экземпляра семейства содержит запрещенные символы.
  ksModelsFamilyEmptyColumns      = 501,  ///< Не определен один или несколько параметров.
  ksModelsFamilyRangeInvalid      = 502   ///< Значение свойства выходит за установленные пределы.
};


/// Cпособ построения эскиза.
enum ksSketchBuildingTypeEnum ENUM_SIZE
{
  ksSketchOnSurface = 0,  ///< На плоскости.
  ksSketchOnTrajectory = 1,  ///< На траектории.
  ksSketchFixed = 2   ///< Фиксированный.
};


/// Тип привязки тела.
enum ksBlockPositionTypeEnum ENUM_SIZE
{
  ksVertex = 0,  ///< Вершина.
  ksEdgeCenter = 1,  ///< Центр ребра параллельного оси x.
  ksFaceCenter = 2   ///< Центр грани.
};


/// Результат операции над поверхностями.
enum ksSurfaceOperationResultEnum ENUM_SIZE
{
  ksSurfaceUnion = 0,  ///< Объединение.
  ksNewSurface = 1   ///< Новая поверхность.
};


/// Направление построения средней поверхности.
enum ksMiddleSurfaceDirectionEnum ENUM_SIZE
{
  ksMiddleSurfaceDirection1 = 0,  ///< От поверхности 1.
  ksMiddleSurfaceDirection2 = 1   ///< От поверхности 2.
};


/// Способ преобразования вставок.
enum ksTransformPartsTypeEnum ENUM_SIZE
{
  ksTransformPartsToBody            = 0,  ///< Преобразовывать в тела.
  ksTransformPartsToBillet          = 1,  ///< Преобразовывать в детали - заготовки.
  ksTransformPartsToBilletNoHistory = 2   ///< Преобразовывать в детали - заготовки без истории.
};


/// Отображение внешних переменных.
enum ksShowExternalVariablesEnum ENUM_SIZE
{
  ksShowDefault = 0,  ///< По умолчанию (показывать для простых вставок, скрыть для стандартных).
  ksShowExternalVariables = 1,  ///< Отображать внешние переменные.
  ksHideExternalVariables = 2   ///< Скрывать  внешние переменные.
};


/// Режим построения трубы.
enum ksPipeBuildingTypeEnum ENUM_SIZE
{
  ksPipeWithTwoDiameters  = 0,  ///< Два диаметра.
  ksPipeWithWallThickness = 1   ///< Диаметр и толщина стенки.
};


/// Направление построения стенки трубы.
enum ksPipeWallDirectionEnum ENUM_SIZE
{
  ksPipeWallInside   = 0,  ///< Внутрь.
  ksPipeWallOutside  = 1   ///< Наружу .
};


/// Тип коллизии.
enum ksCollisionTypeEnum ENUM_SIZE
{
  ksCollisionIntersection        = 0,  ///< Тела пересекаются.
  ksCollisionTouch               = 1,  ///< Тела касаются .
  ksCollisionShortDistance       = 2,  ///< Значение зазора ниже указанного.
  ksCollisionThreadedJointErrors = 3   ///< Ошибки при проверке резьбового соединения.
};


/// Варианты проверки пересечений.
enum ksCollisionRegimeEnum ENUM_SIZE
{
  ksCollisionRegimeSelectedObjects = 0,  ///< Между всеми селектированными объектами.
  ksCollisionRegimeBetweenGroups   = 1   ///< Между двумя группами селектированных объектов.
};


/// Тип ошибки при проверке резьбового соединения.
enum ksJointMismatchEnum ENUM_SIZE
{
  ksJointMismatchLengthOverlap          = 0,  ///< Некорректная глубина резьбового соединения.
  ksJointMismatchDepthOverlap           = 1,  ///< Несовпадение номинальных диаметров резьб.
  ksJointMismatchStep                   = 2,  ///< Несовпадение шага резьб.
  ksJointMismatchRotation               = 3,  ///< Несовпадение направления резьб.
  ksJointMismatchIncompatibleStandards  = 4,  ///< Несовместимые стандарты.
};
