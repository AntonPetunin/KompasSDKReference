...
enum ksNotifyType ENUM_SIZE
{
  ...
  ntPropertyTreeNotify            = 25,  ///< События элемента управления - Дерево.
  ntSelectionManagerNotify        = 26   ///< События для 2D, 3D документов - менеджер селектирования.
};


/// События для KompasObject и IApplication.
enum ksKompasObjectNotifyEnum ENUM_SIZE
{
  ...
  koBeginChoiceMarking          = 20   ///< Начало выбора обозначения в информационных объектах.
};


/// События для документов : Работа с файлом.
enum ksDocumentFileNotifyEnum ENUM_SIZE
{
  ...
  kdActivateToolbarSet      = 15   ///< Активизация набора команд.
};


/// События для основной надписи.
enum ksStampNotifyEnum ENUM_SIZE
{
...
enum ksObject2DNotifyEnum ENUM_SIZE
{
...
enum ksSelectionMngNotifyEnum ENUM_SIZE
{
...
enum ksSpcObjectNotifyEnum ENUM_SIZE
{
...
enum ksSpcDocumentNotifyEnum ENUM_SIZE
{
...
enum ksSpecificationNotifyEnum ENUM_SIZE
{
  ...
  ssSynchronizationBegin         =  8,  ///< Начало синхронизации. (Не используется)
  ssSynchronization              =  9,  ///< Синхронизация проведена. (Не используется)
...
enum ksDocument3DNotifyEnum ENUM_SIZE
{
...
enum ksObject3DNotifyEnum ENUM_SIZE
{
...
enum ksDocument2DNotifyEnum ENUM_SIZE
{
...
enum ksTypeLookStyle ENUM_SIZE
{
...
enum ksPropertyManagerNotifyEnum ENUM_SIZE
{
  ...
  prContextMenuRequest = 20,  ///< Запрос контекстного меню для контрола.
  prMenuCommandUpdate = 21   ///< Установка состояния команд меню для контрола.
};


/// Предопределенные кнопки панели КОМПАС.
enum SpecPropertyButtonEnum ENUM_SIZE
{
  pbEnter        = 1,  ///< Ввод.
  pbEsc          = 2,  ///< Отказ.
...
enum SpecPropertyToolBarEnum ENUM_SIZE
{
...
enum KompasAPIObjectTypeEnum ENUM_SIZE
{
  ...
  ksObjectPropertyUserWindow       = 10015,  ///< Элемент управления - пользовательское окно.
  ...
  ksObjectSheetSpecification = 10082,  ///< Спецификация или таблица изменений на листе.
  ...
  ksObjectPropertyParamGrid = 10133,  ///< Элемент панели свойств - Сетка с разнотипными ячейками.
  ksObjectChoiceModelDialogParam = 10134,  ///< Параметры диалога 'Выбрать модель' из списка открытых.
  ksObjectChoiceMaterialDialogParam = 10135,  ///< Параметры диалога выбора материала.
  ksObjectPropertyTreeNode= 10136,  ///< Интерфейс модели узла дерева.
  ksObjectPropertyTree = 10137,  ///< Элемент панели свойств - Дерево.
  ksObjectSymbolOrSpecSignDialogParam = 10138,  ///< Параметры диалога Символы и спецзнаки.
  ksObjectParametrizationParam = 10139,  ///< Интерфейс параметров параметризации.
  ksObjectInertiaProperties = 10141,  ///< Плоские массо-центровочные характеристики.
  ksObjectMassInertiaProperties = 10142,  ///< Объемные массо-центровочные характеристики.
  ksObjectInertiaPropertiesCalculateParam = 10143,  ///< Параметры для расчёта плоских массо-центровочных характеристик.
  ksObjectMassInertiaPropertiesCalculateParam = 10144,  ///< Параметры для расчёта объёмных массо-центровочных характеристик.
  ksObjectChoiceDocumentFiltersParam = 10145,  ///< Параметры фильтрации в диалоге 'Выбрать файла' из списка открытых.
  ...
  ksObjectCurvesByLaws                     = 11150,  ///< Коллекция кривых по закону.
  ...
  ksObjectCurvesBy2Projections             = 11160,  ///< Коллекция проекционных кривых.
  ...
  ksObjectMeasurement3D                    = 11380,  ///< Измерение расстояния и угла.
  ksObjectMultiSpline3D                    = 11381,  ///< Ассоциативный сплайн по объектам.
  ksObjectMultiSplines3D                   = 11382,  ///< Коллекция ассоциативных сплайнов по объектам.
  ksObjectBodySurfaceRemovers              = 11383,  ///< Коллекция операций удаления тел и поверхностей.
  ksObjectBodySurfaceRemover               = 11384,  ///< Удаление тел и поверхностей.
  ksObjectMeshPatternFacesCopy             = 11385,  ///< Массив граней по сетке.
  ksObjectCircularPatternFacesCopy         = 11386,  ///< Массив граней по концентрической сетке.
  ksObjectCurvePatternFacesCopy            = 11387,  ///< Массив граней вдоль кривой.
  ksObjectMirrorPatternFacesCopy           = 11388,  ///< Зеркальный массив граней.
  ksObjectSketchPatternFacesCopy           = 11389,  ///< Массив граней по точкам.
  ksObjectTablePatternFacesCopy            = 11390,  ///< Массив граней по таблице.
  ...
  ksObjectUserComponentOperation    = 13175,  ///< Пользовательская операция над вставками.
  ksObjectStraightSlots             = 13176,  ///< Коллекция пазов.
  ksObjectStraightSlot              = 13177,  ///< Паз.
  ksObjectArcSlots                  = 13178,  ///< Коллекция пазов дуговых.
  ksObjectArcSlot                   = 13179,  ///< Паз дуговой.
  ksObjectWrappedCurve              = 13180,  ///< Свернутая или развернутая кривая.
  ksObjectWrappedCurves             = 13181,  ///< Коллекция свернутых и развернутых кривых.
  ksObjectAuxMeshObject             = 13182,  ///< Объект окружения.
  ksObjectAuxMeshPrimitive          = 13183,  ///< Примитив объекта окружения.
  ksObjectElementaryBodies          = 13184,  ///< Коллекция элементарных тел.
  ksObjectSphere                    = 13185,  ///< Сфера.
  ksObjectCylinder                  = 13186,  ///< Цилиндр.
  ksObjectBlockByPoints             = 13187,  ///< Параллелепипед по двум точкам и высоте.
  ksObjectBlockBySizes              = 13188,  ///< Параллелепипед по точке и трем размерам.
  ksObjectConeByAngle               = 13189,  ///< Конус по центру основания, диаметрам и углу.
  ksObjectConeByHeight              = 13190,  ///< Конус по центру основания, диаметрам и высоте.
  ksObjectConeByArcs                = 13191,  ///< Конус по двум дугам.
  ksObjectMiddleSurface             = 13192,  ///< Средняя поверхность.
  ksObjectMiddleSurfaces            = 13193,  ///< Коллекция средних поверхностей.
  ksObjectDeleteHistoryParam        = 13194,  ///< Параметры удаления истории построения.
  ksObjectMenu                      = 13195,  ///< Меню.
  ksObjectInsertPartParameters      = 13196,  ///< Параметры добавления вставки модели в сборку.
  ksObjectPipeElement               = 13197,  ///< Трубчатый элемент.
  ksObjectPipeElements              = 13198,  ///< Колекция трубчатых элементов.
  ksObjectCollision                 = 13199,  ///< Проверка коллизий.
  ksObjectCalculateCollisionsResult = 13200,  ///< Результат проверки коллизий.
  ksObjectCollisions                = 13201   ///< Коллекция объектов Проверка коллизий.
};


/// Типы контролов панели свойств.
enum ControlTypeEnum ENUM_SIZE
{
  ...
  ksControlTree         = 45,  ///< Дерево.
  ksControlParamGrid    = 46,  ///< Сетка c разнотипными ячейками.
  ksControlUserWindow = 47,  ///< Элемент управления - пользовательское окно.
  ksControlUVEdit      = 48,  ///< Редактор UV координат.
  ksControlRaPointEdit = 49,  ///< Редактор полярных координат на поверхности.
  ksControlAzPointEdit = 50,  ///< Редактор полярных-цилиндрических координат на поверхности.
  ksControlAbPointEdit = 51   ///< Редактор полярных-сферических координат на поверхности.
};


/// Типы документов КОМПАС.
enum DocumentTypeEnum ENUM_SIZE
{
...
enum SeparatorTypeEnum ENUM_SIZE
{
...
enum PropertyControlNameVisibility ENUM_SIZE
{
...
enum ksPropertyUserControlNotifyEnum ENUM_SIZE
{
...
enum DefaultFixTypeEnum ENUM_SIZE
{
...
enum FrameRegimeEnum ENUM_SIZE
{
...
enum ksDocumentFrameNotifyEnum ENUM_SIZE
{
...
enum StructType2DEnum ENUM_SIZE
{
  ...
  ko_InertiaParam          = 83,  ///< Интерфейс параметров плоских массо-центровочных характеристик ksInertiaParam
...
enum PropertyManagerLayout ENUM_SIZE
{
...
enum ProcessTypeEnum ENUM_SIZE
{
  ...
  prIntersectionsObject           = 10223,  ///< Объекты пересечения с плоскостью эскиза. 
  prInsertionView                 = 10224,  ///< Вставка вида из другого чертежа.
  prStraightSlot                  = 10225,  ///< Паз.
  prArcSlot                       = 10226,  ///< Паз дуговой.
  prParametricLinearArray         = 10227,  ///< Массив по линейной сетке в 2D документе.
  prParametricCircularArray       = 10228,  ///< Массив по концентрической сетке в 2D документе.
  ...
  prBodySurfaceRemover                  = 20237,  ///< Операция удаления тел и поверхностей.
  prModelsFamily                        = 20238,  ///< Семейство моделей.
  prNormalTo                            = 20239,  ///< Нормально к...
  prOrientationNormalToAndAling         = 20240,  ///< Повернуть нормально и выровнять.
  prExportObjects                       = 20241,  ///< Экспорт.
  prChangeRefInstances                  = 20242,  ///< Процесс замены ссылок на вставки моделей.
  prChangeRefObjects                    = 20243,  ///< Процесс замены ссылок на объекты.
  prMeasureDistanceBetweenObjects       = 20244,  ///< Взаимное отклонение.
  prMechDeviation                       = 20245,  ///< Анализ отклонений.
  prFilletChanger                       = 20246,  ///< Изменить размер скругления.
  prReplaceFaces                        = 20247,  ///< Заменить грани.
  prFaceResizer                         = 20248,  ///< Изменить размер грани.
  prCrossSections                       = 20249,  ///< Управление сечениями.
  prSphere                              = 20250,  ///< Сфера.
  prCylinder                            = 20251,  ///< Цилиндр.
  prBlockBySizes                        = 20252,  ///< Параллелепипед по точке и трём размерам.
  prBlockByPoints                       = 20253,  ///< Параллелепипед по двум точкам и высоте.
  prRuledSurfaceByCurveAndFace          = 20254,  ///< Линейчатая поверхность по кривой и поверхности.
  prRuledSurfaceByFaceTangCurve         = 20255,  ///< Линейчатая поверхность по кривой касательно к поверхности.
  prRuledSurfaceByCurveAndfDirection    = 20256,  ///< Линейчатая поверхность по кривой и направлению.
  prTable3D                             = 20257,  ///< Таблица 3D.
  prFilletSurface                       = 20258,  ///< Поверхность скругления.
  prSelectionBandRegular                = 20259,  ///< Документ 3D. Выделить рамкой.
  prSelectionBandSecant                 = 20260,  ///< Документ 3D. Выделить секущей рамкой.
  prConeByAngle                         = 20261,  ///< Конус по центру основания, диаметрам и углу.
  prConeByHeight                        = 20262,  ///< Конус по центру основания, диаметрам и высоте.
  prConeByArcs                          = 20263,  ///< Конус по двум дугам.
  prMiddleSurface                       = 20264,  ///< Средняя поверхность.
  prPartsChangeSources                  = 20265,  ///< Заменить компоненты.
  prImportObjects                       = 20266,  ///< Импорт.
  prPipeElement                         = 20267,  ///< Трубчатый элемент.
  prCutPipeElement                      = 20268,  ///< Вырезать трубчатым элементом.
  prMeshPatternFacesCopy     = 20269,  ///< Массив граней по сетке.
  prCircularPatternFacesCopy = 20270,  ///< Массив граней по концентрической сетке.
  prCurvePatternFacesCopy    = 20271,  ///< Массив граней вдоль кривой.
  prMirrorPatternFacesCopy   = 20272,  ///< Зеркальный массив граней.
  prSketchPatternFacesCopy   = 20273,  ///< Массив граней по точкам.
  prTablePatternFacesCopy    = 20274,  ///< Массив граней по таблице.
...
enum DocumentCloseOptions ENUM_SIZE
{
...
enum ConvertCoordTypeEnum ENUM_SIZE
{
...
enum FilterConditionStateEnum ENUM_SIZE
{
...
enum LayersGroupWayEnum ENUM_SIZE
{
...
enum DrawingObjectTypeEnum ENUM_SIZE
{
  ...
  ksDrStraightSlot       = 87,  ///< Паз.
  ksDrArcSlot            = 88,  ///< Паз дуговой.
...
enum ksViewsAndLayersManagerNotifyEnum ENUM_SIZE
{
...
/// Типы библиотек.
enum ksLibraryTypeEnum ENUM_SIZE
{
...
enum ksLibraryStyleEnum ENUM_SIZE
{
...
enum ksLibraryManagerNotifyEnum ENUM_SIZE
{
...
enum ksSystemControlStartEnum ENUM_SIZE
{
...
enum ksSpecificationVariantEnum ENUM_SIZE
{
...
enum ksSpecificationLinkTypeEnum ENUM_SIZE
{
  ksLinkNone                  = 0,  ///< Нет.
  ksLinkOnlyObjects           = 1,  ///< Только вставка объектов спецификации. (Не используется).
  ksLinkWithPositionCalculate = 2   ///< Связь с расчетом позиций.
};


/// Типы колонок спецификации.
enum ksSpecificationColumnTypeEnum ENUM_SIZE
{
...
enum ksValueTypeEnum ENUM_SIZE
{
...
/// Форматы листа.
enum ksDocumentFormatEnum ENUM_SIZE
{
...
enum ksTabulatorFillingEnum ENUM_SIZE
{
...
enum ksSpecificationObjectTypeEnum ENUM_SIZE
{
  ...
  ksSpecificationCommonName      = 8  ///< Общее наименование.
};


/// Состояние объекта спецификации.
enum ksSpecificationObjectStateEnum ENUM_SIZE
{
...
enum ksLayoutSheetsNotifyEnum ENUM_SIZE
{
...
enum ksKOMPASConverterEnum ENUM_SIZE
{
...
enum ksLengthUnitEnum ENUM_SIZE
{
...
enum ksEditListTypeEnum ENUM_SIZE
{
...
enum ksEditListCommandEnum ENUM_SIZE
{
...
enum ksAPITypeEnum ENUM_SIZE
{
  ...
  ksAPI      = 4   ///< KsAPI - интерфейсы.
};


/// Типы дерева построения 3D документа.
enum ksTreeTypeEnum ENUM_SIZE
{
...
/// Команды Компаса.
enum ksKompasCommandEnum ENUM_SIZE
{
  ...
  ksCMParametryzeEnable    = 35714,  ///< Включить или выключить параметрический режим.
  ...
  ksCMRebuildAssociationView = 35767,  ///< Перестроить ассоциативный вид.
  ...
  ksCM3DReplaceComponentsOnOff  = 40372,  ///< Сборка - Разнести компоненты.
  ...
  ksCMDynamicCrossSection       = 62160,  ///< Сечение модели.
  ksCMHideTexts                 = 62360,  ///< Скрыть надписи.
  ksCMHideInCompTexts           = 62361,  ///< Скрыть надписи во вставках.
  ksCMHideTables                = 62368,  ///< Скрыть таблицы.
  ksCMHideInCompTables          = 62369,  ///< Скрыть таблицы во вставках.
  ksCMSelectPartsBySource       = 63792,  ///< Выбор по источнику.
...
enum ksHideMessageEnum ENUM_SIZE
{
...
enum ksTextNumberingEnum ENUM_SIZE
{
...
enum ksTextHorizontalFormatEnum ENUM_SIZE
{
...
/// Размещенеие объекта.
enum ksAllocationEnum ENUM_SIZE
{
  ksAlLeft    = 0,  ///< Слева.
...
enum ksMarkInsideFormEnum ENUM_SIZE
{
...
enum ksMarkOnLinePosTypeEnum ENUM_SIZE
{
...
/// Направление полки.
enum ksShelfDirectionEnum ENUM_SIZE
{
  ksLSLeft  = -1,  ///< Влево.
...
enum ksDrawingObjectParamTypeEnum ENUM_SIZE
{
  ...
  ksLocalCSAllParam = -12   ///< Параметры в системе координат текущей системы координат вида.
};


/// Тип узла марки.
enum ksMarkNodeEnum ENUM_SIZE
{
...
enum ksCurveStyleEnum ENUM_SIZE
{
  ...
  ksCSDotted                    = 26   ///< Пунктирная линия.
};


/// Системные стили текста.
enum ksTextStyleEnum ENUM_SIZE
{
...
enum ksContourFormEnum ENUM_SIZE
{
...
/// Тип фигурной скобки.
enum ksAlignmentTypeEnum ENUM_SIZE
{
...
/// Единицы измерения длины.
enum ksLengthUnitsEnum ENUM_SIZE
{
...
enum ksMassUnitsEnum ENUM_SIZE
{
  ksMUnGR   = 0,  ///< Граммы
...
enum ksMassSettingModeEnum ENUM_SIZE
{
...
enum ksConstraintTypeEnum ENUM_SIZE
{
  ...
  ksCLinearArray        = 23,  ///< Массив по линейной сетке.
  ksCCircularArray      = 24   ///< Массив по концентрической сетке.
};


/// Стили отображения пространсвенной точки.
enum ksAnnotationSymbolEnum ENUM_SIZE
{
...
enum ksDimensionTextAlignEnum ENUM_SIZE
{
...
/// Размер в скобках.
enum ksDimensionTextBracketsEnum ENUM_SIZE
{
...
enum ksDimensionDeviationEnum ENUM_SIZE
{
...
enum ksDimensionTextTypeEnum ENUM_SIZE
{
...
enum ksDimensionBaseEnum ENUM_SIZE
{
...
enum ksDimensionTextPosEnum ENUM_SIZE
{
...
enum ksDimensionArrowPosEnum ENUM_SIZE
{
...
enum ksLineDimensionOrientationEnum ENUM_SIZE
{
...
/// Тип размеров высоты.
enum ksHeightDimTypeEnum ENUM_SIZE
{
...
enum ksAngleDimTypeEnum ENUM_SIZE
{
...
enum ksDimTextFormatEnum ENUM_SIZE
{
...
enum ksRoughSignEnum ENUM_SIZE
{
...
enum ksLeaderSignEnum ENUM_SIZE
{
...
enum ksPositionLederFormEnum ENUM_SIZE
{
...
enum ksChangeLeaderSignEnum ENUM_SIZE
{
...
enum ksTolerancePrefixSignEnum ENUM_SIZE
{
  ksTPSNone        = 0,  ///< Нет.
...
enum ksToleranceSuffixSignEnum ENUM_SIZE
{
  ksTSNone       = 0,  ///< Нет.
...
enum ksTablePointEnum ENUM_SIZE
{
...
enum ksTableTileLayoutEnum ENUM_SIZE
{
...
/// Типы границ таблицы.
enum ksCellBoundariesEnum ENUM_SIZE
{
...
enum ksCheckSumVersionEnum ENUM_SIZE
{
...
enum ksRequestFilesTypeEnum ENUM_SIZE
{
  ...
  koRFSpcAssemblyAddDocument   = 12,  ///< Подключение документов КОМПАС к спецификации - Управление подключенными документами.
  ...
  koRFSelectModelsFamilyTable               = 19,  ///< Выбор файла таблицы семейства моделей.
  koRFSelectImportFile                      = 20   ///< Выбор файла для импорта в текущую модель.
};


/// Типы ограничений в вершинах мультилинии.
enum ksMlVertexLimiterEnum ENUM_SIZE
{
...
enum ksMlEndLimiterEnum ENUM_SIZE
{
...
enum ksMlVertexTrackingEnum ENUM_SIZE
{
...
enum ksContourSegmentEnum ENUM_SIZE
{
...
enum ksAnnotativeTerminatorSignEnum ENUM_SIZE
{
...
/// Тип угла объекта.
enum ksCornerTypeEnum ENUM_SIZE
{
...
enum ksInsertionTypeEnum ENUM_SIZE
{
...
enum ksEquidistantTypeEnum ENUM_SIZE
{
...
enum ksCentreMarkerEnum ENUM_SIZE
{
...
enum ksSemiAxisTypeEnum ENUM_SIZE
{
...
enum ksAttributeTypeEnum ENUM_SIZE
{
...
enum ksRelativeProjectionTypeEnum ENUM_SIZE
{
...
/// Тип линии разрыва.
enum ksBreakLineTypeEnum ENUM_SIZE
{
...
enum ksHatchStyleEnum ENUM_SIZE
{
...
/// Тип региона.
enum ksRegionTypeEnum ENUM_SIZE
{
...
/// Тип заливки.
enum ksColouringTypeEnum ENUM_SIZE
{
...
enum ksSheetsRangeEnum ENUM_SIZE
{
...
enum ksOutputColorTypeEnum ENUM_SIZE
{
...
/// Типы свойств.
enum ksPropertyTypeEnum ENUM_SIZE
{
...
enum ksReportFiltersTypeEnum ENUM_SIZE
{
...
/// Тип ссылки на текст.
enum ksHypertextTypeEnum ENUM_SIZE
{
...
/// Тип гиперссылки.
enum ksHyperLinkTypeEnum ENUM_SIZE
{
...
enum ksChooseManagerTypeEnum ENUM_SIZE
{
...
enum ksRecoverErrorEnum ENUM_SIZE
{
...
enum ksBisectorVariant ENUM_SIZE
{
...
/// Тип внешнего файла
enum ksExternalFilesTypesEnum ENUM_SIZE
{
  ...
  ksEFTTuningStyleSectionsBlock = 38   ///< Документ для связи с заголовком блока.
};


/// Типы булевых операций над телами и замкнутыми кривыми.
enum ksBooleanType ENUM_SIZE
{
...
enum ksNewDocumentSettingsTypeEnum ENUM_SIZE
{
...
enum ksMaterialPropertyTypeEnum ENUM_SIZE
{
...
enum ksVariantMarkingTypeEnum ENUM_SIZE
{
...
/// Тип отчета.
enum ksReportTypeEnum ENUM_SIZE
{
...
enum ksValueFormatEnum ENUM_SIZE
{
...
enum ksGroupeTypeEnum ENUM_SIZE
{
...
/// Формат нумерации.
enum ksNumberingTypeEnum ENUM_SIZE
{
...
enum ksRowsNumberingTypeEnum ENUM_SIZE
{
...
enum ksReportStyleInitEnum ENUM_SIZE
{
...
/// Тип листа.
enum ksSheetTypeEnum ENUM_SIZE
{
...
enum ksDrawInScreenPlaneEnum ENUM_SIZE
{
...
/// Выравнивание текста.
enum ksTextAlignEnum ENUM_SIZE
{
  ksTALeft             = 0,  ///< Слева.
  ksTARight            = 2,  ///< Справа.
...
enum ksReportBuildingTypeEnum ENUM_SIZE
{
...
enum ksPageLayoutTypeEnum ENUM_SIZE
{
...
enum ksObjectPropertyControlTypeEnum ENUM_SIZE
{
...
/// Типы принтеров.
enum ksPrinterTypeEnum ENUM_SIZE
{
...
enum ksSpecificationStyleDifferenceTypeEnum ENUM_SIZE
{
...
enum ksSlaveDocumentTypeEnum ENUM_SIZE
{
...
enum ksNurbsByPointsBuildingTypeEnum ENUM_SIZE
{
...
enum ksNurbsByPointsPointConstraintsEnum ENUM_SIZE
{
  ksNByPBPCNone     = 0,  ///< Нет.
...
enum ksNurbsByPointsAproximationTypeEnum ENUM_SIZE
{
...
enum ksKompasVariantEnum ENUM_SIZE
{
...
enum ksCheckBoxVisualStyleEnum ENUM_SIZE
{
  ksCheckBoxDefault     = 0,  ///< Обычный.
  ksCheckBoxSwitcher    = 1,  ///< Переключатель.
  ksCheckBoxOptional    = 2   ///< С неопределенным состоянием.
};


/// Типы фантома.
enum ksPhantomTypeEnum ENUM_SIZE
{
...
/// Типы процессов 2D.
enum ksProcess2DTypeEnum ENUM_SIZE
{
...
/// События процесса 2D.
enum ksProcess2DNotifyEnum ENUM_SIZE
{
...
/// События процесса 3D.
enum ksProcess3DNotifyEnum ENUM_SIZE
{
...
/// Типы процессов 3D.
enum ksProcess3DTypeEnum ENUM_SIZE
{
...
enum ksTwinSwitcherValueEnum ENUM_SIZE
{
...
enum ksToleranceArrowType ENUM_SIZE
{
  ksTANone     = 0,  ///< Нет.
  ksTAArrow    = 1,  ///< Стрелка.
...
enum ksProcessContextMenuType ENUM_SIZE
{
...
enum ksEnterButtonIconTypeEnum ENUM_SIZE
{
...
/// Тип стрелки ответвления у допуска формы.
enum ksShowHideTmpObjTypeEnum ENUM_SIZE
{
...
enum ksDocumentsLibraryInsertionTypeEnum ENUM_SIZE
{
...
enum ksRedrawDocumentModeEnum ENUM_SIZE
{
...
enum ksProductObjectTypeEnum ENUM_SIZE
{
  ...
  ksPOTAppObject          = 0x200   ///< Объект Компас-приложений.
};


/// Версия сохранения файла.
enum ksSaveDocumentVersionEnum ENUM_SIZE
{
  ...
  ksSDV_Kompas_23       = 29,  ///< В версию Компас 23
  ksSDV_Kompas_24       = 30   ///< В версию Компас 24
};


/// События диалога с произвольным наполнением.
enum ksContentDialogNotifyEnum ENUM_SIZE
{
...
enum ksSpcUsedTypeEnum ENUM_SIZE
{
...
enum ksConicCurvePontIndexEnum ENUM_SIZE
{
...
/// Тип поиска объектов.
enum ksFindObjectsTypeEnum ENUM_SIZE
{
  ...
  ksFindTimmedCurve   =  8,  ///< Кривая имеющая граничные точки.
...
enum ksFindObjectParametersNotifyEnum ENUM_SIZE
{
...
enum ksProcess3DManipulatorsNotifyEnum ENUM_SIZE
{
...
enum ksPointLocationTypeEnum ENUM_SIZE
{
...
enum ksStylesLibraryTypeEnum ENUM_SIZE
{
...
/// Тип стиля кривой.
enum ksCurveStyleTypeEnum ENUM_SIZE
{
...
enum ksCurvePenTypeEnum ENUM_SIZE
{
...
enum ksProtectProductStatusEnum ENUM_SIZE
{
...
/// Модули Компас.
enum ksKompasModuleEnum ENUM_SIZE
{
...
/// Вариант отрисовки.
enum ksModelRenderTypeEnum ENUM_SIZE
{
...
enum ksModelPerformanceLevelEnum ENUM_SIZE
{
...
/// Прозрачность.
enum ksModelTransparencyTypeEnum ENUM_SIZE
{
...
enum ksPLMStatusEnum ENUM_SIZE
{
...
enum ksPLMChangesEnum ENUM_SIZE
{
...
enum ksPLMObjectNotifyEnum ENUM_SIZE
{
  ...
  ksPLMCompositionChanged  =  1004   ///< Изменение состояния состава в системе версионирования.
};


/// События функции поиска объектов 3D.
enum ksFindObject3DParametersNotifyEnum ENUM_SIZE
{
...
enum ksNumericGroupTypeEnum ENUM_SIZE
{
...
/// Типы точек размеров.
enum ksDimensionPointEnum ENUM_SIZE
{
  ...
  ksDimensionExtensionLinePoint  = 4   ///< Точка на продолжении размерной линии.
};


/// Типы точек обозначений.
enum ksDesignationPointEnum ENUM_SIZE
{
...
/// Типы изображений.
enum ksRasterFormatEnum ENUM_SIZE
{
...
enum ksPLMPropertyEnum ENUM_SIZE
{
...
enum ksMultiPageOutputEnum ENUM_SIZE
{
...
/// Тип цвета.
enum ksObjectColorTypeEnum ENUM_SIZE
{
  ksColorBw            = 0,  ///< Черный
...
enum ksRoughModificationEnum ENUM_SIZE
{
...
enum ksDecimalDelimiterTypeEnum ENUM_SIZE
{
...
/// Признак типа угла.
enum ksAngleTypeEnum ENUM_SIZE
{
  ksError   = -2,  ///< Ошибка.
...
enum ksSystemPathTypeEnum ENUM_SIZE
{
...
enum ksMathCurve2DTypeEnum ENUM_SIZE
{
...
/// Тип переменной.
enum ksVariableTypeEnum ENUM_SIZE
{
...
/// Тип пересечения.
enum ksCurvesIntersectFormEnum ENUM_SIZE
{
  ksCurvesIntectSimple  = 0,  ///< Обыкновенная точка пересечения.
  ksCurvesIntectTangent = 1,  ///< Касательная точка пересечения.
  ksCurvesIntersectSimple  = 0,  ///< Обыкновенная точка пересечения.
  ksCurvesIntersectTangent = 1   ///< Касательная точка пересечения.
};


/// Способ форматирования имени файла при первом сохранении.
enum ksFileNameMakeModeEnum ENUM_SIZE
{
...
enum ksSurfaceSalientTypeEnum ENUM_SIZE
{
...
enum ksChangeOrderType ENUM_SIZE
{
...
enum ksObjectConstraintsStateEnum ENUM_SIZE
{
...
enum ksConstraintsStateEnum ENUM_SIZE
{
...
enum ksCreateCommonNameState ENUM_SIZE
{
...
/// События пользовательского элемента управления - Дерево.
enum ksPropertyTreeNotifyEnum ENUM_SIZE
{
  ksTreeSelectNodes       = 1,  ///< Узел селектирован.
  ksTreeUnselectNodes     = 2,  ///< Узел селектирован.
  ksTreeCollapseNode      = 3,  ///< Узел свернут.
  ksTreeExpandNode        = 4,  ///< Узел развернут.
  ksTreeNodeDblClick      = 5,  ///< Двойной клик по узлу дерева.
  ksTreeNodeBeginTextEdit = 6,  ///< Событие начала переименования узла дерева.
  ksTreeNodeEndTextEdit   = 7,  ///< Событие завершения переименования узла дерева.
  ksTreeNodeDragStarted   = 8,  ///< Событие начала перемещения узла.
  ksTreeNodeDragOver      = 9,  ///< Событие перемещения узла.
  ksTreeNodeDragDroped    = 10,  ///< Событие окончания перемещения узла.
  ksTreeContextMenuRequest= 11   ///< Запрос контекстного меню для узла дерева.
};


/// Уровень декомпозиции.
enum ksDecomposeObjectLevelEnum ENUM_SIZE
{
  ksDOLSegmentsArcsTextsPoints = 0,  ///< Отрезки, дуги, тексты, точки.
  ksDOLSegmentsTextsPoints = 1,  ///< Отрезки, тексты, точки.
  ksDOLSegmentsArcsTexts = 2,  ///< Отрезки, дуги, тексты.
  ksDOLSegmentsArcsPoints = 4,  ///< Отрезки, дуги, точки, тексты(не разбиваем).
  ksDOLSegmentsArcsTextsArrowsBases = 5,  ///< Отрезки, дуги, тексты, заливки стрелок и треугольников баз.
  ksDOLProjectionCurves = 6,  ///< Видимые и невидимые участки проекционных кривых.
  ksDOLCompositeObjects = 7   ///< Составные объекты на составляющие объекты, простые объекты - копии.
};


/// Состояния состава в системе версионирования.
enum ksPLMCompositionEnum ENUM_SIZE
{
  ksPLMCompositionUndefined      = 0,  ///< Состояние не задано.
  ksPLMCompositionNotRegistered  = 1,  ///< Состав объекта не синхронизирован.
  ksPLMCompositionObjectNotSync  = 2,  ///< Состав объекта синхронизирован.
  ksPLMCompositionObjectSync     = 3,  ///< Состав дочерних объектов не синхронизирован.
  ksPLMCompositionObjectsNotSync = 4,  ///< Состав объектов не синхронизирован.
  ksPLMCompositionConflict       = 5   ///< Конфликт.
};


/// Типы пути в библиотеке моделей.
enum ksChoiceFromLibraryResultEnum ENUM_SIZE
{
  ksChoiceFromLibraryCancel      = 0,  ///< Отказ от выбора пути.
  ksChoiceFromLibraryRoot        = 1,  ///< Выбрана корневая директория.
  ksChoiceFromLibraryFolder      = 2,  ///< Выбрана подпапка.
  ksChoiceFromLibraryDocument    = 3   ///< Выбран документ.
};


/// Выбор действия при перетаскивании узла.
enum ksDropPermissionEnum ENUM_SIZE
{
  ksDropAfter     = 0,  ///< Разрешить вставку узла после выбранного узла.
  ksDropInto      = 1,  ///< Разрешить вставку узла внутрь выбранного узла.
  ksDropCopyInto  = 2,  ///< Разрешить вставку узла внутрь выбранного узла с копированием.
  ksDropForbidden = 3   ///< Запретить вставку.
};


/// Тип конвертации текста.
enum ksTextConvertEnum ENUM_SIZE
{
  ksTextConvertDefault               = 0,  ///< По умолчанию.
  ksTextConvertDestroyHyperTextRefs  = 3,  ///< Текст ссылок выдавать простым текстом.
  ksTextConvertPlainText             = 4   ///< Преобразовать в простой текст без управляющих символов.
};


/// Индекс точки паза.
enum ksStraightSlotPointEnum ENUM_SIZE
{
  ksStraightSlotArcCentre1 = 1,  ///< Первый центр.
  ksStraightSlotArcCentre2 = 2,  ///< Второй центр.
  ksStraightSlotPoint1     = 3,  ///< Первая точка.
  ksStraightSlotPoint2     = 4,  ///< Вторая точка.
  ksStraightSlotCentre     = 5   ///< Центр паза.
};


/// Способ построения паза.
enum ksStraightSlotBuildingType ENUM_SIZE
{
  ksStraightSlotArcCenters          = 1,  ///< По центрам.
  ksStraightSlotGabarit             = 2,  ///< По габариту.
  ksStraightSlotCentreArcCentre = 3,  ///< От средней точки по центрам.
  ksStraightSlotCentreGabarit   = 4   ///< От средней точки по габариту.
};


/// Способ выравнивания сечения.
enum ksSectionAlignmentEnum ENUM_SIZE
{
  ksSectionAlignmentByParam = 0,  ///< По параметру направляющих.
  ksSectionAlignmentByLen   = 1   ///< По длине направляющих.
};


/// Индекс точки паза дугового.
enum ksArcSlotPointEnum ENUM_SIZE
{
  ksArcSlotArcCentre1 = 1,  ///< Первый центр.
  ksArcSlotMiddle     = 2,  ///< Точка на оси паза.
  ksArcSlotArcCentre2 = 3,  ///< Второй центр.
  ksArcSlotCentre     = 4   ///< Центр паза.
};


/// Cпособ построения паза дугового.
enum ksArcSlotBuildingType ENUM_SIZE
{
  ksArcSlotByCentre = 1,  ///< По центу.
  ksSlotByPoints  = 2   ///< По трем точкам.
};


/// Способ подсветки объекта.
enum ksLightObjectTypeEnum ENUM_SIZE
{
  ksSelectObject  = 0,  ///< Подсветка цветом выделения.
  ksLightObject   = 1   ///< Подсветка цветом выбора .
};


/// Система квалитета.
enum ksQualitySystemEnum ENUM_SIZE
{
  ksQualSystemShaft = 1,  ///< Вала.
  ksQualSystemHole  = 2   ///< Отверстия.
};


/// Типы квалитетов.
enum ksQualityTypeEnum ENUM_SIZE
{
  ksQualityPreferable = 1,  ///< Предпочтительные.
  ksQualityBasic      = 2,  ///< Основные.
  ksQualityAdditional = 3   ///< Дополнительные.
};


/// Признак режима редактирования объектов спецификации.
enum ksSlaveActiveEnum ENUM_SIZE
{
  ksSlaveClosed = 0,  ///< Окно редактирования объектов спецификации не открыто.
  ksSlaveOpen   = 1,  ///< Окно редактирования объектов спецификации открыто но не активно.
  ksSlaveActive = 2   ///< Окно редактирования объектов спецификации открыто и активно.
};


/// Тип проверяемых объектов.
enum ksCheckObjectsTypeEnum ENUM_SIZE
{
  ksCheckCurrentView     = 0,  ///< Текущий вид.
  ksCheckAllViews        = 1,  ///< Все виды.
  ksCheckSelectedObjects = 2   ///< Выделенные объекты.
};


/// Стиль проверяемых объектов.
enum ksCheckStyleEnum ENUM_SIZE
{
  ksCheckAllStyles = 0x01,  ///< Все стили.
  ksCheckNormal    = 0x02,  ///< Основная.
  ksCheckAxial     = 0x04,  ///< Осевая.
  ksCheckThin      = 0x08,  ///< Тонкая.
  ksCheckOther     = 0x10   ///< Другие.
};


/// Результат проверки ассоциативности объектов.
enum ksCheckAssociationResultEnum ENUM_SIZE
{
  ksCheckAssociationOk            = 0,  ///< Успешно.
  ksCheckAssociationNoDimensions  = 1,  ///< Невозможно создание ассоциативных связей. Нет размеров.
  ksCheckAssociationNoGeomObjects = 2,  ///< Невозможно создание ассоциативных связей. Нет геометрических объектов.
  ksCheckAssociationNoObjects     = 3,  ///< Невозможно создание ассоциативных связей. Нет объектов.
  ksCheckAssociationComplete      = 4   ///< Все размеры ассоциативны. Создание ассоциативных связей не требуется.
};


/// Набор кнопок, отображаемых в окне сообщения.
enum ksMessageButtonSetEnum ENUM_SIZE
{
  ksButtonSetOk = 0x00000000L,  ///< ОК.
  ksButtonSetOkCancel = 0x00000001L,  ///< ОК и Отмена.
  ksButtonSetYesNoCancel = 0x00000003L,  ///< Да, Нет и Отмена.
  ksButtonSetYesNo = 0x00000004L   ///< Да и Нет.
};


/// Тип отображаемого сообщения.
enum ksMessageTypeEnum ENUM_SIZE
{
  ksMessageError = 0x00000010L,  ///< Сообщение об ошибке.
  ksMessageQuestion = 0x00000020L,  ///< Вопросительное сообщение.
  ksMessageWarning = 0x00000030L,  ///< Предупреждающее сообщение.
  ksMessageInformation = 0x00000040L   ///< Информационное сообщение.
};


/// Кнопка, нажатая в окне сообщения.
enum ksMessageButtonEnum ENUM_SIZE
{
  ksButtonOk      = 1,  ///< Ок.
  ksButtonCancel  = 2,  ///< Отмена.
  ksButtonYes     = 6,  ///< Да.
  ksButtonNo      = 7   ///< Нет.
};


/// Типы характерных точек.
enum ksHotPointEnum ENUM_SIZE
{
  ksHPDefault             = -1,  ///< По умолчанию.
...
/// Стандартные системные курсоры.
enum ksCursorEnum ENUM_SIZE
{
  ksCursorDefault = 0,  ///< Курсор в виде креста.
  ksCursorSelect  = 0xFFFE,  ///< Курсор для выбора объектов.
  ksCursorSnap    = 0xFFFD,  ///< Курсор для выбора привязок.
  ksCursorCatch   = 0xFFFC,  ///< Курсор для поиска объектов.
  ksCursorArrow  = 32512,  ///< Стрелка.
  ksCursorHand   = 32649,  ///< Рука.
  ksCursorHelp   = 32651,  ///< Помощь.
  ksCursorIbeam  = 32513,  ///< I.
  ksCursorNo  = 32648,  ///< Отсутствие курсора.
  ksCursorSizeAll  = 32646,  ///< Произвольное изменение размера.
  ksCursorSizeNESW  = 32643,  ///< Изменение размера по диагонали NE - SW.
  ksCursorSizeNS  = 32645,  ///< Изменение размера по вертикали.
  ksCursorSizeNWSE  = 32642,  ///< Изменение размера по диагонали NW - SE.
  ksCursorSizeWE  = 32644,  ///< Изменение размера по горизонтали.
  ksCursorUpArrow  = 32516,  ///< Стрелка вверх.
  ksCursorWait  = 32514   ///< Часы.
};


/// Типы курсоров для характерных точек.
enum ksHotPointCursorEnum ENUM_SIZE
{
  ksHPCursorDefault      = 0,  ///< По умолчанию.
  ksHPCursorPlusPoint    = 1,  ///< Крест.
  ksHPCursorMove         = 8,  ///< Перемещение.
  ksHPCursorRotate       = 9,  ///< Поворот.
  ksHPCursorArrowLeft    = 10,  ///< Стрелка слева.
  ksHPCursorArrowRight   = 11,  ///< Стрелка справа.
  ksHPCursorStop         = 12,  ///< Стоп.
  ksHPCursorSizeNESW     = 13,  ///< Изменение размера по диагонали NE - SW .
  ksHPCursorSizeNS       = 14,  ///< Изменение размера по вертикали.
  ksHPCursorSizeNWSE     = 15,  ///< Изменение размера по диагонали NW - SE.
  ksHPCursorSizeWE       = 16,  ///< Изменение размера по горизонтали.
  ksHPCursorSizeAll      = 17,  ///< Произвольное изменение размера.
  ksHPCursorSizePMNESW   = 18,  ///< Дискретное изменение размера по диагонали NE - SW.
  ksHPCursorSizePMNS     = 19,  ///< Дискретное изменение размера по вертикали.
  ksHPCursorSizePMNWSE   = 20,  ///< Дискретное изменение размера по диагонали NW - SE.
  ksHPCursorSizePMWE     = 21,  ///< Дискретное изменение размера по горизонтали.
  ksHPCursorOrtogonal    = 22  ///< Ортогональность.
};


/// Тип операторов сравнения фильтра.
enum ksFilterOperatorTypeEnum ENUM_SIZE
{
  ksFilterOperatorUnknown = 0,  ///< Тип не определен.
  ksFilterOperatorAND     = 1,  ///< И.
  ksFilterOperatorOR      = 2   ///< ИЛИ.
};


/// Тип усечения кривой.
enum ksCurveTrimTypeEnum ENUM_SIZE
{
  ksCurveDeletePart       = 0,  ///< Удалить часть кривой.
  ksCurveTrimmed          = 1,  ///< Построить усеченную кривую.
  ksCurveTrimmedAndDelete = 2   ///< Построить усеченную кривую и удалить старую.
};


/// Тип загрузки компонента.
enum ksLoadStateEnum ENUM_SIZE
{
...
/// Тип элемента меню.
enum ksMenuItemTypeEnum ENUM_SIZE
{
  ksMenuItemTypeError      = 0,  ///< Ошибка.
  ksMenuItemTypeMenuItem   = 1,  ///< Пункт меню.
  ksMenuItemTypeSubMenu    = 2,  ///< Вложенное меню.
  ksMenuItemTypeSeparator  = 3   ///< Разделитель.
};


/// Способ задания расстояния.
enum ksStepFactorEnum ENUM_SIZE
{
  ksStepBetweenExtremeCopies      = 0,  ///< Шаг задан расстоянием между крайними экземплярами.
  ksStepBetweenAdjacentCopies   = 1   ///< Шаг задан расстоянием между соседними экземплярами.
};


/// Способ использования объекта в массиве.
enum ksArrayObjectUsesEnum ENUM_SIZE
{
  ksArrayObjectUnused     = 0,  ///< Не используется.
  ksArrayInitialObject    = 1,  ///< Исходный копируемый объект.
  ksArrayExemplarObject   = 2,  ///< Объект является экземпляром.
  ksArrayDimensionObject  = 3   ///< Объект является размером, созданным массивом.
};


/// Состояние подключения приложения при запуске Компас.
enum ksLibraryAutoStartStatusEnum ENUM_SIZE
{
  ksLibraryAutoStartOff = 0,  ///< Приложение отключено.
  ksLibraryAutoStartOn  = 1,  ///< Приложение подключается автоматически.
  ksLibraryStopped      = 2,  ///< Приложение приостановлено.
};
